...
__C.MOTION.FLOWSE3.EP_LAMBDA = 0.1;

__C.MOTION.TRAIN = edict()
# penelize residual following FlowSE3 layer
__C.MOTION.TRAIN.RESIDUAL_WEIGHT = 0.01
# avoids case where all flow weights get set to 0
__C.MOTION.TRAIN.WEIGHT_WEIGHT = 0.01
...
__C.MOTION.TRAIN.RANDOM_INIT = 0.0
__C.MOTION.TRAIN.K = 2048
